...
main :: IO()
main = do
    print $ getClosestDistance [(ThreeD 4 5 6), (ThreeD 2 5 10)] == (4.47213595499958, ThreeD 2.0 5.0 10.0, ThreeD 4.0 5.0 6.0)
    print $ getClosestDistance [(ThreeD 4 5 6), (ThreeD 2 5 10), (ThreeD 5 2 (-10)), (ThreeD (-2) 1 45), (ThreeD 12 0 2)] == (4.47213595499958, ThreeD 2.0 5.0 10.0, ThreeD 4.0 5.0 6.0)
    ...
    print $ getClosestDistance [(TwoD 4 6), (TwoD 5 10), (TwoD 5 29), (TwoD 1 45), (TwoD 0 2), (TwoD 69 42)] == (4.123105625617661, TwoD 5.0 10.0, TwoD 4.0 6.0)
...
getClosestDistance ps = foldr1 (\p1@(d1, _, _) p2@(d2, _, _) -> if d1 < d2 then p1 else p2) distances
    where 
